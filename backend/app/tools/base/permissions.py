...
class ToolPermissionEngine:
    ...
    def __init__(self):
        ...
        self._registry: Dict[str, PermissionPolicy] = {
            ...
            "calendar_modify": PermissionPolicy.REQUIRE_APPROVAL,
            "calendar_delete": PermissionPolicy.REQUIRE_APPROVAL,
            "calendar_batch_schedule": PermissionPolicy.REQUIRE_APPROVAL,
            "calendar_batch_modify": PermissionPolicy.REQUIRE_APPROVAL,
            "calendar_batch_delete": PermissionPolicy.REQUIRE_APPROVAL,
